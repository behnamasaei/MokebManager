...
namespace MokebManagerNg.Migrations
{
    ...
    [Migration("20240723195817_Merge Name and Family to Name")]
    partial class MergeNameandFamilytoName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MokebManagerNg.ClockEntryExit", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("AppClockEntryExit", (string)null);
                });

            modelBuilder.Entity("MokebManagerNg.EntryExitZaer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("AppEntryExitZaer", (string)null);
                });

            modelBuilder.Entity("MokebManagerNg.Mokeb", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MokebManagerNg.ClockEntryExit", b =>
                {
                    b.HasOne("MokebManagerNg.Zaer", "Zaer")
                        .WithMany("ClockEntryExits")
                        .HasForeignKey("ZaerId")
            ...
            modelBuilder.Entity("MokebManagerNg.EntryExitZaer", b =>
                {
                    b.HasOne("MokebManagerNg.Mokeb", null)
                        .WithMany("EntryExitZaers")
                        .HasForeignKey("MokebId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MokebManagerNg.Zaer", "Zaer")
                        .WithMany("EntryExitZaerDates")
                        .HasForeignKey("ZaerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
